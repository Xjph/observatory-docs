...
### v2.0.1 - Herald Two-Point...One?!

Minor bugfix release to fix lack of default selection for API. 2.0.0 notes below.

Release versions:
  * [EOP](https://xjph.net/Observatory/Herald/2.0.1/ObservatoryHerald.eop)
