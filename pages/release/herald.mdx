...
**IMPORTANT: Using the Herald plugin requires a Patreon pledge, an Azure Cognitive Services account, or access to an OpenAI voice API.**

## Latest 

### v2.1.0

Minor feature release that adds support for the improved messaging and update check in Observatory Core v1.3.0.

Release versions:
  * [EOP](https://github.com/Xjph/ObservatoryHerald/releases/download/v2.1.0/ObservatoryHerald.eop)

### v2.0.2 - Herald Two-Point Oh...Two?!

Bugfix release 2.0.2 fixes lack of default selection for API and broken direct Azure support. More general 2.0.x notes below.

Release versions:
  * [EOP](https://xjph.net/Observatory/Herald/2.0.2/ObservatoryHerald.eop)


The long-awaited return of [the Herald plugin](/usage/plugins/herald)!

Last November I was forced to take Herald offline; a sudden spike in usage caused the cost of providing the Azure based voices to become unsustainable. At the time I said that at some future date it may return as a Patreon bonus for those supporting the project, and now that day has arrived. Anyone [backing the project on Patreon *at any tier*](https://patreon.com/vithigar) will have access to Herald via the Observatory API.
