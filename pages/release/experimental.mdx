...
> **Wine 9.0+ is required.** Prior versions have issues with .NET 8. If using Lutris you may need to change the application config if the default Wine environment is something older.
