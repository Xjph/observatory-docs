...
**MAJOR KNOWN ISSUE:** Settings are not being saved between launches, so you will have to set up the journal path and other settings from scratch on every launch. Fix hopefully before the weekend.
