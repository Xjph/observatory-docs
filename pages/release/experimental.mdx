...
This is an experimental and likely bug-riddled version with some build-time tweaks to improve compatability with Wine.
...
If you try this please let me know how it goes. I've only given it the most cursory of initial testing, basically just making sure it run.