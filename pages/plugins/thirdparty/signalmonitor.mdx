...
SignalMonitor is an optional [plugin](/plugins) for the Observatory, designed to report upon certain interesting signals while exploring.
...
## Usage
  ...
  * SignalMonitor will send a configurable [notification](/notifications) for these events.
