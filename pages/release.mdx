...
## Latest - v1.1.3 - Quick Ascendancy Bugfix
...
Quick fix for crashes while in the bubble for players pledged to powers, plus some error handling improvements in general. More likely coming soon as the full scope of changes to the journal for Ascendancy is are handled.
