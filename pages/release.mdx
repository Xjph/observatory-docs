...
Quick fix for crashes while in the bubble for players pledged to powers, plus some error handlig improvements in general. More likely coming soon as the full scope of changes to the journal for Ascendancy is are handled.
