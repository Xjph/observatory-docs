...
Release versions:
  * [Installer](https://github.com/Xjph/ObservatoryCore/releases/download/v1.0.1/ObservatorySetup.exe)
  * [Portable](https://github.com/Xjph/ObservatoryCore/releases/download/v1.0.1/ObservatoryPortable.zip)
