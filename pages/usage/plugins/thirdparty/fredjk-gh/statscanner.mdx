...
See the [Changelog page](https://github.com/fredjk-gh/ObservatoryPlugins/wiki/Plugin:-Stat-Scanner) for release notes and the [GitHub wiki](https://github.com/fredjk-gh/ObservatoryPlugins/wiki) for download links or install via the AutoUpdater.
