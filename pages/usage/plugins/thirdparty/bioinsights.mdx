...
BioInsights is an optional plugin for Observatory, designed to aid cataloguing the biological signals found in Elite Dangerous.
...
![An example of a body mapped by BioInsights.](/bioinsights-example.png)
*An example of a body mapped by BioInsights.*

Like [Botanist](/usage/plugins/botanist), BioInsights divides its output into several subsections:
