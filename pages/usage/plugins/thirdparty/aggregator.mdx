...
The ✅ or "Interest Tracking" column allows you to mark notifications with intent to visit. Click the 🔍 icon to mark
something as interesting and it becomes an empty checkbox. When you've visited the body, click the empty checkbox to
check it off (✅). If you map the body or land on it, it will automatically be checked off for you. Note that this
state is not persisted.

See the [Changelog page](https://github.com/fredjk-gh/ObservatoryPlugins/wiki/Plugin:-Aggregator) for release notes and download links or install via the AutoUpdater.
