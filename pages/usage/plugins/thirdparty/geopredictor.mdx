...
GeoPredictor is an optional [plugin](/usage/plugins) for Observatory, designed to detect and report planetary geological signals.
...
![An example output from GeoPredictor.](/geopredictor-example.png)
