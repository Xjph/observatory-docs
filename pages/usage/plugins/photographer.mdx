...
> **Note:** This plugis is currently available to paid [patreon members only](https://www.patreon.com/c/vithigar) for a limited period. It will be made freely available to all users at a later date, at which point it will be bundled with the regular release of Observatory.
