...
*Note: This plugin requires either an active Patreon pledge or for the user to provide their own Azure Cognitive Services subscription or access to a speech service providing an OpenAI speech API endpoint.*
