...
* [Herald](/usage/plugins/herald): Improved voice notifications.
...
### Mining
  ...
  * [Prospector](/usage/plugins/thirdparty/fredjk-gh#prospector): Mining and hotspot information.
...
### Navigation
  ...
  * [Fleet Commander](https://github.com/fredjk-gh/ObservatoryPlugins/wiki): Comprehensive fleet carrier information and routing tool.
  * [Helm](https://github.com/fredjk-gh/ObservatoryPlugins/wiki) `(BETA)`: A flight assistant providing heads-up notifications, flight information and statistics.

### Data and Statistics

  * [Archivist](https://github.com/fredjk-gh/ObservatoryPlugins/wiki) `(BETA)`: Journal archive and browser.
  * [Stat Scanner](https://github.com/fredjk-gh/ObservatoryPlugins/wiki): Personal bests and galactic record information.
