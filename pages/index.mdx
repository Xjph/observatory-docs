...
If you're interested in Custom Criteria for Explorer in particular you can find [the documentation for using them here in the wiki](/plugins/explorer/custom-criteria).
