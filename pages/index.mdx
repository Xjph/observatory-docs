...
## What Is It?
Observatory Core differs from the original Elite Observatory in that it is a fully generic reader for the Elite Dangerous journal files, passing those events along to [plugins](/usage/plugins) to do the actual work.
...
For specifics on what each plugin does, please refer to their respective wiki pages:
  ...
  * [BioInsights](/usage/plugins/bioinsights)
